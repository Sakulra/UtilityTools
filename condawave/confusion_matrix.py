...
#snr=20海洋环境模拟
# cm = np.array([
#     [27466, 713, 782, 964, 260],
#     [2248, 27906, 12, 58, 225],
#     [812, 84, 27842, 1601, 188],
#     [684, 156, 601, 28693, 350],
#     [941, 694, 402, 1516, 26802]
# ])
#snr=10海洋环境模拟
cm = np.array([
    [26388, 1128, 1017, 1286, 366],
    [3124, 26671, 31, 127, 496],
    [1286, 173, 26611, 2218, 239],
    [1048, 296, 1022, 27487, 631],
    [1517, 1033, 691, 2324, 24790]
])
